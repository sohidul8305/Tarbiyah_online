...
const Due_salary = () => {
  ...
  const uniqueMonths = [
    "All",
    ...new Set(dueSalaryRecords.map((r) => r.month)),
  ];
  const uniqueYears = [
    "All",
  ...
  const totalOverdue = dueSalaryRecords
  ...
  const handleAddDueSalary = (e) => {
    ...
    const newRecord = {
      ...
      teacherId:
        formData.teacherId ||
        `TCH${String(dueSalaryRecords.length + 1).padStart(3, "0")}`,
    ...
    Swal.fire({
      icon: "success",
      title: "Due Salary Added!",
      text: `Due salary record for ${formData.teacherName} has been added.`,
      timer: 1500,
      showConfirmButton: false,
    });
  };
  ...
  const handleEditDueSalary = (e) => {
    ...
    Swal.fire({
      icon: "success",
      title: "Due Salary Updated!",
      text: "Due salary record has been updated successfully.",
      timer: 1500,
      showConfirmButton: false,
    });
  };
  ...
  const handleDeleteDueSalary = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        setDueSalaryRecords(dueSalaryRecords.filter((r) => r.id !== id));
        Swal.fire("Deleted!", "Due salary record has been deleted.", "success");
      }
    });
  };
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
            ...
            record.id === selectedDue.id
              ? {
                  ...
                  transactionId:
                    ...
                    `TXN-DUE-${String(Date.now()).slice(-6)}`,
                  notes:
                    record.notes +
                    (record.notes ? " | " : "") +
        ...
        Swal.fire({
          ...
          text: `${formatCurrency(selectedDue.netSalary)} has been paid to ${selectedDue.teacherName}.`,
          timer: 1500,
          showConfirmButton: false,
        });
      }
  ...
  const downloadReport = () => {
    Swal.fire({
      ...
      text: "Due salary report is being downloaded as PDF.",
      timer: 1500,
      showConfirmButton: false,
    });
  };
  ...
  const exportToExcel = () => {
    Swal.fire({
      ...
      text: "Due salary report is being exported to Excel format.",
      timer: 1500,
      showConfirmButton: false,
    });
  };
    ...
    <div className="h-screen flex flex-col bg-gray-50 overflow-hidden">
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <div className="md:hidden bg-white border-b border-gray-200 p-3 flex justify-between items-center w-full absolute top-0 left-0 z-40">
          <h1 className="text-sm font-bold text-gray-800">Due Salary</h1>
          <button
          ...
          <div className="bg-white p-3 rounded-xl shadow-sm border border-gray-200 mb-3 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
            <div>
              <h1 className="text-base font-bold text-gray-800 flex items-center gap-2">
                <FaMoneyBillWaveIcon className="text-red-600" /> Due Salary
              </h1>
              <p className="text-xs text-gray-500">
                Manage pending and overdue teacher salaries
              </p>
            </div>
                  ...
                  {filteredRecords.length > 0 ? (
                      ...
                      >
                        ...
                        <td className="px-3 py-2 hidden sm:table-cell text-gray-600">
                          ...
                          {record.daysOverdue > 0 && (
                            <span className="block text-[8px] text-red-500">
                    ...
                    <tr>
                      ...
                      >
                        ...
                        <p>No due salary records found</p>
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200 flex justify-between items-center sticky top-0 bg-white z-10">
              <h3 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                <FaPlus className="text-red-600" /> Add Due Salary
              </h3>
              <button
            ...
            <form onSubmit={handleAddDueSalary} className="p-6 space-y-4">
              <div>
      ...
      {showEditModal && selectedDue && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200 flex justify-between items-center sticky top-0 bg-white z-10">
              <h3 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                <FaEdit className="text-yellow-600" /> Edit Due Salary
              </h3>
              <button
            ...
            <form onSubmit={handleEditDueSalary} className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Teacher Name *
                </label>
      ...
      {showDetailsModal && selectedDue && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full">
            <div className="p-6 border-b border-gray-200 flex justify-between items-center sticky top-0 bg-white z-10">
              <h3 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                <FaInfoCircle className="text-blue-600" /> Due Salary Details
              </h3>
              <button
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center justify-between pb-4 border-b border-gray-200">
                <div>
                  <h2 className="text-lg font-bold text-gray-800">
                    {selectedDue.teacherName}
                  </h2>
                  <p className="text-sm text-gray-500">
                    {selectedDue.teacherId}
                  </p>
                </div>
                <span
                  className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(selectedDue.status)}`}
                >
                  {getStatusIcon(selectedDue.status)}
                  {selectedDue.status}
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-gray-50 rounded-lg p-3">
                  <p className="text-[10px] text-gray-400">Days Overdue</p>
                  <p className="text-sm font-semibold text-red-600">
                    {selectedDue.daysOverdue} days
                  </p>
                </div>
                {selectedDue.paymentMethod && (
                  <div className="bg-gray-50 rounded-lg p-3">
            ...
            <div className="p-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center">
                  <FaMoneyBillWaveIcon className="text-green-600 text-2xl" />
                </div>
                <div>
              ...
              <div className="space-y-2 text-sm text-gray-600 mb-4">
                ...
                <p>
                  <strong>Month:</strong> {selectedDue.month} {selectedDue.year}
                </p>
                <p>
                  <strong>Due Date:</strong> {formatDate(selectedDue.dueDate)}
                </p>
                <p>
