        ...
        <div className="flex flex-col md:flex-row gap-10 items-start">
          ...
          <div className="w-full md:w-2/3">
            ...
            <p className="font-semibold text-lg text-blue-600 mb-8">
              An endless journey has begun for the sake of humanity
            </p>
            <p className="text-gray-700 leading-loose">
              Born in 80s, Professor Mokhtar Ahmad completed his graduation from
              the most revered institution in Bangladesh, University of Dhaka.
              He then dedicated himself towards the fulfillment of his dream...
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row-reverse gap-10 items-start">
          ...
          <div className="w-full md:w-2/3">
            <h2 className="text-2xl font-bold text-blue-600 mb-4">
              JOURNEY TO ALLAH: A COMPASSIONATE MAN BEHIND THE SCENE
            </h2>
            <p className="text-gray-700 leading-loose">
              Syed Jihadul Islam, Founder CEO at Tarbiyah Education Network &
              Founder General Secretary at Tarbiyah Foundation, is a Pragmatic &
              Goal-oriented man...
            </p>
            <p className="text-gray-700 leading-loose mt-4">
              Syed Jihadul Islam is a seasoned business strategist. The moment
              he has arrived in professional life, he has thrived in RMG
              industries...
            </p>
          </div>
        </div>
