            ...
            <div className="rounded-md shadow-sm -space-y-px">
              <div>
                ...
                <input
                  ...
                  autoComplete="email"
                  disabled={loading}
                  className="appearance-none rounded-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-2 focus:ring-[#004d4d] focus:border-[#004d4d] focus:z-10 sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed"
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={loading}
                  className="appearance-none rounded-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-2 focus:ring-[#004d4d] focus:border-[#004d4d] focus:z-10 sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed"
