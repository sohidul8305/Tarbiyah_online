...
// Import certificate image (same as QuidaNurani)
...
const NazeraDetails = () => {
  ...
  // --- TESTIMONIALS (copied from QuidaNuraniDetails) ---
  const testimonials = [
    {
      id: 1,
  ...
  // --- VIDEO GALLERY (copied from QuidaNuraniDetails) ---
  const videoGallery = [
    {
      id: 1,
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex flex-col justify-between">
      ...
      <div className="py-8 px-4 sm:px-6 lg:px-8 flex-grow">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Hero Section Banner (Fixed size like QuidaNurani) */}
          <img
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* শিক্ষার্থী ও অভিভাবকদের অভিজ্ঞতা (UPDATED with QuidaNurani testimonials) */}
              ...
              {/* ভিডিও গ্যালারি (UPDATED with QuidaNurani videos) */}
              <div className="bg-white rounded-3xl p-8 shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-1 h-8 bg-yellow-500 rounded-full"></div>
                  <h2 className="text-2xl font-bold text-[#00ADD2]">
            ...
            <div className="space-y-4 lg:-mt-[305px]">
              {/* Video Thumbnail (Fixed size like QuidaNurani) */}
              <a
