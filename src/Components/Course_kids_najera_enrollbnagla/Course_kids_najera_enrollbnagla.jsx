...
const Course_kids_najera_enrollbnagla = () => {
  ...
  // কোর্সের তথ্য - Nazera Course
  const courseInfo = {
    name: "নাজেরা আদিলাত কোর্স",
    price: 6000,
    subtotal: 6000,
    bkashCharge: 0,
    total: 6000,
...
export default Course_kids_najera_enrollbnagla;
