...
const AlimiyahKidsEnroll = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.studentName) errors.studentName = "শিশুর নাম প্রয়োজন";
    if (!formData.studentAge) errors.studentAge = "শিশুর বয়স প্রয়োজন";
    if (createAccount) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <Link
            to="/course/alemiah/alimiyah-kids"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        placeholder="শিশুর শ্রেণী (যদি থাকে)"
                      />
                    </div>
                  </div>
                </div>
...
export default AlimiyahKidsEnroll;
