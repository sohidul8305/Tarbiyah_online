  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <Link
            to="/course/alemiah/alimiyah-program"
          ...
          <div className="lg:col-span-7">
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
              <div className="border-b border-gray-200 pb-6 mb-6">
                <h1 className="text-2xl font-bold text-[#002b2b] flex items-center gap-2">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                {/* Additional Information for Alimiyah Program */}
                <div>
                  <h2 className="text-lg font-bold text-[#002b2b] mb-4 flex items-center gap-2">
                    <FaMosque className="text-yellow-500" />
                    PROGRAM INFORMATION
                  </h2>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="আপনার পূর্ববর্তী শিক্ষা (যেমন: এইচএসসি, স্নাতক)"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all"
                        placeholder="আপনার আগ্রহের বিষয়সমূহ (যেমন: তাফসীর, ফিকহ)"
                      />
                    </div>
                  </div>
                </div>
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 sticky top-24">
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-orange-50 p-4 rounded-xl mb-6 border border-yellow-200">
                <h3 className="font-bold text-[#002b2b] text-center flex items-center justify-center gap-2">
                  <FaGraduationCap className="text-yellow-500" />
                  Here's Alimiyah Program
                </h3>
...
export default AlimiyahProgramEnroll;
