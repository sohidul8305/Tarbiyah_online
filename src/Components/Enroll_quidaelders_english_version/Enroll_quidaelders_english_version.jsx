...
const Enroll_quidaelders_english_version = () => {
  ...
  // Course Info - Elders Quida (English Version)
  const courseInfo = {
    name: "Quran Studies for Elders",
    price: 5000,
    subtotal: 5000,
    bkashCharge: 0,
    total: 5000,
...
export default Enroll_quidaelders_english_version;
