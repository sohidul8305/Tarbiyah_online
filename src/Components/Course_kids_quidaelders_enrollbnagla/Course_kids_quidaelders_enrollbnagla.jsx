...
const Course_kids_quidaelders_enrollbnagla = () => {
  ...
  // কোর্সের তথ্য - Elders Quida Course
  const courseInfo = {
    name: "কুরআন স্টাডিজ ফর এল্ডার্স",
    price: 5000,
    subtotal: 5000,
    bkashCharge: 0,
    total: 5000,
...
export default Course_kids_quidaelders_enrollbnagla;
