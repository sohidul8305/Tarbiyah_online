...
const NazeraEnroll = () => {
  ...
  // রেস্ট সব ফাংশন QuidaEnroll এর মতো কিন্তু কালার emerald
  const validateForm = () => {
    const errors = {};
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
              <div className="border-b border-gray-200 pb-6 mb-6">
                <h1 className="text-2xl font-bold text-emerald-800 flex items-center gap-2">
                  <FaQuran className="text-emerald-500" />
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        placeholder="বর্তমান কুরআন শিক্ষার স্তর"
                      />
                    </div>
                  </div>
                </div>

                {/* Shipping Information - Same as QuidaEnroll but with emerald color */}
                <div>
                  <h2 className="text-lg font-bold text-emerald-800 mb-4 flex items-center gap-2">
                ...
                <div className="flex items-start gap-3 bg-emerald-50 p-4 rounded-xl border border-emerald-200">
                  ...
                  <div>
                    <p className="text-sm text-gray-700">
                      ...
                      <button className="text-emerald-600 hover:text-emerald-700 font-semibold mx-1">
                        terms & conditions
                      </button>
                      ,
                      <button className="text-emerald-600 hover:text-emerald-700 font-semibold mx-1">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold py-4 rounded-xl hover:shadow-2xl transition-all transform hover:scale-[1.02] flex items-center justify-center gap-3 text-lg ${
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 sticky top-24">
              <div className="border-b border-gray-200 pb-6 mb-6">
                ...
                <button className="text-sm text-emerald-600 hover:text-emerald-700 font-semibold mt-1 flex items-center gap-1">
                  <FaTag />
              ...
              <div className="bg-gradient-to-r from-emerald-50 to-teal-50 p-4 rounded-xl mb-6 border border-emerald-200">
                <h3 className="font-bold text-emerald-800 text-center flex items-center justify-center gap-2">
                  <FaQuran className="text-emerald-500" />
                  Here's Nazera
                </h3>
              ...
              <div className="space-y-3 border-b border-gray-200 pb-6">
                ...
                <div className="flex justify-between items-center py-3 border-t-2 border-emerald-600 mt-2">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 flex-1">
                      <FaCreditCard className="text-emerald-500 text-xl" />
              ...
              <button
                ...
                disabled={loading}
                className={`w-full mt-6 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold py-4 rounded-xl hover:shadow-2xl transition-all transform hover:scale-[1.02] flex items-center justify-center gap-3 ${
                  loading ? "opacity-70 cursor-not-allowed" : ""
                }`}
              >
                {loading ? (
