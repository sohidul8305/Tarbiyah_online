...
const QuidaEnroll = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.studentAge) errors.studentAge = "শিক্ষার্থীর বয়স প্রয়োজন";
    if (createAccount) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <Link
            to="/course/kids/quida-nurani"
            className="inline-flex items-center gap-2 text-teal-700 hover:text-teal-900 transition-colors group"
          >
          ...
          <div className="lg:col-span-7">
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        placeholder="পূর্ববর্তী কুরআন শিক্ষার অভিজ্ঞতা (যদি থাকে)"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 bg-teal-50 p-4 rounded-xl border border-teal-200">
                  <input
                    type="checkbox"
                    className="mt-1 w-4 h-4 text-teal-500 rounded"
                    required
                  />
                  <div>
                    <p className="text-sm text-gray-700">
                      You've read and accept the
                      <button className="text-teal-600 hover:text-teal-700 font-semibold mx-1">
                        terms & conditions
                      </button>
                      ,
                      <button className="text-teal-600 hover:text-teal-700 font-semibold mx-1">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full bg-gradient-to-r from-teal-500 to-emerald-500 text-white font-bold py-4 rounded-xl hover:shadow-2xl transition-all transform hover:scale-[1.02] flex items-center justify-center gap-3 text-lg ${
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 sticky top-24">
              <div className="border-b border-gray-200 pb-6 mb-6">
                ...
                <button className="text-sm text-teal-600 hover:text-teal-700 font-semibold mt-1 flex items-center gap-1">
                  <FaTag />
              ...
              <div className="bg-gradient-to-r from-teal-50 to-emerald-50 p-4 rounded-xl mb-6 border border-teal-200">
                <h3 className="font-bold text-teal-800 text-center flex items-center justify-center gap-2">
                  <FaBook className="text-teal-500" />
                  Here's Quida Nurani
                </h3>
              ...
              <div className="space-y-3 border-b border-gray-200 pb-6">
                ...
                <div className="flex justify-between items-center py-3 border-t-2 border-teal-600 mt-2">
                  <span className="text-lg font-bold text-teal-800">Total</span>
              ...
              <button
                ...
                disabled={loading}
                className={`w-full mt-6 bg-gradient-to-r from-teal-500 to-emerald-500 text-white font-bold py-4 rounded-xl hover:shadow-2xl transition-all transform hover:scale-[1.02] flex items-center justify-center gap-3 ${
                  loading ? "opacity-70 cursor-not-allowed" : ""
                }`}
              >
                {loading ? (
