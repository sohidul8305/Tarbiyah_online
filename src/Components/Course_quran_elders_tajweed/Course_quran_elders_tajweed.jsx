  ...
  const testimonials = [
    {
      ...
      quote:
        "আলহামদুলিল্লাহ, এই কোর্সটি আমার তাজবিদ জ্ঞানকে অনেক সমৃদ্ধ করেছে। উস্তাদের নির্দেশনায় আমি তাজবিদের সকল নিয়ম সহজে বুঝতে পেরেছি।",
      image: "https://i.pravatar.cc/150?img=11",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      quote:
        "তাজবিদ কোর্সটি আমার তিলাওয়াতের মান অনেক উন্নত করেছে। উস্তাদের শিক্ষা পদ্ধতি সত্যিই অসাধারণ।",
  ...
  const faqs = [
    {
      ...
      answer:
        "অবশ্যই। তাজবিদ শেখার জন্য বয়স কোনো বাধা নয়। এই কোর্সটি বিশেষভাবে প্রাপ্তবয়স্কদের প্রয়োজন বিবেচনায় তৈরি করা হয়েছে।",
    },
    {
      question: "এই কোর্সের মূল উদ্দেশ্য কী?",
      answer:
        "সঠিক মাখরাজ ও তাজবিদের নিয়ম শেখানো এবং কুরআন তিলাওয়াতে তা প্রয়োগ করতে সক্ষম করে তোলা।",
    },
    {
      question: "তাজবিদ শিখতে কত সময় লাগে?",
      answer:
        "এই কোর্সটি ৪ মাসের একটি প্রোগ্রাম। তবে শিক্ষার্থীর সক্ষমতার উপর ভিত্তি করে সময় পরিবর্তন হতে পারে।",
    },
    {
      question: "কোর্স শেষে আমি কি তাজবিদ শিখতে পারব?",
      answer:
        "হ্যাঁ। এই কোর্সটি সম্পূর্ণ করার পর আপনি তাজবিদের সকল নিয়ম শিখতে এবং কুরআন তিলাওয়াতে তা প্রয়োগ করতে সক্ষম হবেন।",
    },
    {
    ...
    },
    {
      ...
      answer:
        "আমাদের শিক্ষকবৃন্দ ইজাজাহপ্রাপ্ত, অভিজ্ঞ এবং তাজবিদ শিক্ষাদানে প্রশিক্ষিত। তাঁরা দীর্ঘদিন ধরে অনলাইন ও অফলাইন উভয় মাধ্যমে পাঠদান করছেন।",
    },
  ];
