...
const HifzRevisionEnroll = () => {
  ...
  // Same functions with blue color
  const validateForm = () => {
    const errors = {};
    ...
    if (!formData.memorizedJuz)
      errors.memorizedJuz = "মুখস্থ পারার সংখ্যা প্রয়োজন";
    if (createAccount) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const paymentData = {
        ...
        memorizedJuz: formData.memorizedJuz,
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        MEMORIZED JUZ <span className="text-red-500">*</span>
                      </label>
                      <input
                        type="text"
                        name="memorizedJuz"
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-3 border ${
                          formErrors.memorizedJuz
                            ? "border-red-500"
                            : "border-gray-300"
                        } rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all`}
                        placeholder="মোট কত পারা মুখস্থ (যেমন: ১০ পারা)"
                      />
                      {formErrors.memorizedJuz && (
                        <p className="text-red-500 text-xs mt-1">
                          {formErrors.memorizedJuz}
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        placeholder="যে পারাগুলোতে দুর্বলতা আছে (যেমন: ৫, ৮, ১৫ পারা)"
                      />
                    </div>
                  </div>
                </div>

                {/* Shipping Information with blue color */}
                <div>
                  <h2 className="text-lg font-bold text-blue-800 mb-4 flex items-center gap-2">
                ...
                <div className="flex items-start gap-3 bg-blue-50 p-4 rounded-xl border border-blue-200">
                  ...
                  <div>
                    <p className="text-sm text-gray-700">
                      ...
                      <button className="text-blue-600 hover:text-blue-700 font-semibold mx-1">
                        terms & conditions
                      </button>
                      ,
                      <button className="text-blue-600 hover:text-blue-700 font-semibold mx-1">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-bold py-4 rounded-xl hover:shadow-2xl transition-all transform hover:scale-[1.02] flex items-center justify-center gap-3 text-lg ${
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 sticky top-24">
              <div className="border-b border-gray-200 pb-6 mb-6">
                ...
                <button className="text-sm text-blue-600 hover:text-blue-700 font-semibold mt-1 flex items-center gap-1">
                  <FaTag />
              ...
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-4 rounded-xl mb-6 border border-blue-200">
                <h3 className="font-bold text-blue-800 text-center flex items-center justify-center gap-2">
                  <FaSync className="text-blue-500" />
                  Here's Hifz Revision
                </h3>
              ...
              <button
                ...
                disabled={loading}
                className={`w-full mt-6 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-bold py-4 rounded-xl hover:shadow-2xl transition-all transform hover:scale-[1.02] flex items-center justify-center gap-3 ${
                  loading ? "opacity-70 cursor-not-allowed" : ""
                }`}
              >
                {loading ? (
