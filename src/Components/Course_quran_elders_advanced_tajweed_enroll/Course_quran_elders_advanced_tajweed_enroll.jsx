...
const Course_quran_elders_advanced_tajweed_enroll = () => {
  ...
  // Course Info - Advanced Tajweed Course
  const courseInfo = {
    name: "অ্যাডভান্সড তাজউইদ কোর্স",
    price: 5200,
    subtotal: 5200,
    bkashCharge: 0,
    total: 5200,
  ...
  return (
    <div className="min-h-screen bg-white text-[#333333] font-sans">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        {/* Back Button */}
        <Link
          to="/course/quran/elders-advanced-tajweed"
          className="inline-flex items-center gap-2 text-[#002b2b] hover:text-yellow-600 mb-4 transition-colors group text-sm"
        >
        ...
        <div className="bg-[#f8f9fa] border border-gray-200 rounded-md p-3 mb-6 flex justify-between items-center text-sm">
          ...
          <span className="font-bold text-[#004d61]">৳ 5,200</span>
        </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-[#004d61]">
                    অ্যাডভান্সড তাজউইদ কোর্স × 1
                  </p>
                  <p className="text-xs text-gray-500">
                    ৳ 1,300 / month and a ৳ 3,900 sign-up fee
                  </p>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between py-3 border-b border-gray-200 text-base font-bold text-[#004d61]">
                <span>Total</span>
                <span className="text-[#004d61]">৳ 5,200</span>
              </div>
              ...
              <div className="flex justify-between py-3 border-b border-gray-200 text-xs font-bold">
                ...
                <div className="text-right">
                  <p className="text-[#004d61]">৳ 1,300 / month</p>
...
export default Course_quran_elders_advanced_tajweed_enroll;
