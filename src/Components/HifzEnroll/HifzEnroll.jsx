...
const HifzEnroll = () => {
  ...
  // Same functions as before with purple color
  const validateForm = () => {
    const errors = {};
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const paymentData = {
        ...
        memorizedParts: formData.memorizedParts,
      };
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        placeholder="ইতিমধ্যে মুখস্থ করা পারার সংখ্যা (যেমন: ৫ পারা)"
                      />
                    </div>
                  </div>
                </div>

                {/* Shipping Information with purple color */}
                <div>
                  <h2 className="text-lg font-bold text-purple-800 mb-4 flex items-center gap-2">
                ...
                <div className="flex items-start gap-3 bg-purple-50 p-4 rounded-xl border border-purple-200">
                  <input
                    type="checkbox"
                    className="mt-1 w-4 h-4 text-purple-500 rounded"
                    required
                  />
                  <div>
                    <p className="text-sm text-gray-700">
                      You've read and accept the
                      <button className="text-purple-600 hover:text-purple-700 font-semibold mx-1">
                        terms & conditions
                      </button>
                      ,
                      <button className="text-purple-600 hover:text-purple-700 font-semibold mx-1">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-bold py-4 rounded-xl hover:shadow-2xl transition-all transform hover:scale-[1.02] flex items-center justify-center gap-3 text-lg ${
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 sticky top-24">
              <div className="border-b border-gray-200 pb-6 mb-6">
                ...
                <button className="text-sm text-purple-600 hover:text-purple-700 font-semibold mt-1 flex items-center gap-1">
                  <FaTag />
              ...
              <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-4 rounded-xl mb-6 border border-purple-200">
                <h3 className="font-bold text-purple-800 text-center flex items-center justify-center gap-2">
                  <FaMemory className="text-purple-500" />
                  Here's Hifz Program
                </h3>
              ...
              <div className="space-y-3 border-b border-gray-200 pb-6">
                ...
                <div className="flex justify-between items-center py-3 border-t-2 border-purple-600 mt-2">
              ...
              <button
                ...
                disabled={loading}
                className={`w-full mt-6 bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-bold py-4 rounded-xl hover:shadow-2xl transition-all transform hover:scale-[1.02] flex items-center justify-center gap-3 ${
                  loading ? "opacity-70 cursor-not-allowed" : ""
                }`}
              >
                {loading ? (
