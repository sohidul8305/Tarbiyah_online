...
const Enroll_bajeraelders_english_version = () => {
  ...
  // Course Info - Nazera Course (English Version)
  const courseInfo = {
    name: "Nazera Adilat Course",
    price: 6000,
    subtotal: 6000,
    bkashCharge: 0,
    total: 6000,
    recurringSubtotal: "৳ 1,500 / month",
    recurringTotals: "৳ 1,500 / month",
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-[#004d61]">
                    Nazera Adilat Course × 1
                  </p>
                  <p className="text-xs text-gray-500">
                    ৳ 1,500 / month and a ৳ 4,500 sign-up fee
                  </p>
                </div>
              </div>
...
export default Enroll_bajeraelders_english_version;
