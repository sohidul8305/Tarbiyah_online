...
const AlimiyahProgramEnrollBangla = () => {
  ...
  // কোর্সের তথ্য (সঠিক লেআউট অনুযায়ী আপডেট করা হয়েছে)
  const courseInfo = {
  ...
  return (
    <div className="min-h-screen bg-white text-[#333333] font-sans">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        {/* Top Toggleable Enrolment Summary Bar (Visible on mobile/desktop as in screenshot) */}
        <div className="bg-[#f8f9fa] border border-gray-200 rounded-md p-3 mb-6 flex justify-between items-center text-sm">
          ...
          <span className="font-bold text-[#004d61]">৳ 6,000</span>
        </div>

        {/* Expandable summary box if clicked */}
        {showEnrolmentSummaryMobile && (
          <div className="bg-white border border-gray-200 rounded-md p-4 mb-6 shadow-sm">
            <div className="flex items-center justify-between pb-3 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-[#004d61]">
                    Tarbiyah Alimiyah Program (Bangladesh) × 2
                  </p>
              ...
              <span className="font-bold text-sm">৳ 6,000</span>
            </div>
          ...
          <div>
              ...
              <div className="flex items-center justify-between pb-3">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-xs font-bold text-[#004d61]">
                    Tarbiyah Alimiyah Program (Bangladesh)
                  </p>
                </div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between py-3 border-b border-gray-200 text-base font-bold text-[#004d61]">
                <span>Total</span>
                <span className="text-[#004d61]">৳ 6,000</span>
              </div>
...
export default AlimiyahProgramEnrollBangla;
